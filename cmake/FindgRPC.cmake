...
function(GRPC_GENERATE_CPP SRCS HDRS)
  ...
  set(_protobuf_include_path ${CMAKE_CURRENT_SOURCE_DIR}/protos)
  ...
  foreach(FIL ${ARGN})
    ...
    add_custom_command(
      ...
      ARGS --grpc_out=${CMAKE_BINARY_DIR} --plugin=protoc-gen-grpc=${gRPC_CPP_PLUGIN} -I ${_protobuf_include_path} ${ABS_FIL}
